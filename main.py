...
class AbsencesPreferencesPage(QWidget):
    ...
    def __init__(
        ...
        self._btn_today = QPushButton("Current Month")
        ...
        nav2 = QHBoxLayout()
        nav2.addStretch(1)
        nav2.addWidget(self._btn_prev)
        nav2.addWidget(self._btn_today)
        nav2.addWidget(self._btn_next)
        nav2.addStretch(1)
        root.addLayout(nav2)
...
class SolverTabPage(QWidget):
    def __init__(
        ...
        *,
        ...
        self._btn_today_month = QPushButton("Current Month")
        ...
        today_row.addWidget(self._btn_prev_month)
        today_row.addWidget(self._btn_today_month)
        today_row.addWidget(self._btn_next_month)
        today_row.addStretch(1)
...
class MainWindow(QMainWindow):
    ...
    def _build_schedule_tab(self) -> QWidget:
        ...
        today_row = QHBoxLayout()
        today_row.addStretch(1)
        today_row.addWidget(self._btn_prev)
        today_row.addWidget(self._btn_today)
        today_row.addWidget(self._btn_next)
        today_row.addStretch(1)
